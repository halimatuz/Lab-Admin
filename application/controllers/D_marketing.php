...
class D_marketing extends CI_Controller 
{
    ...
    public function report_quotation() {
		...
		if ($sess == NULL) {
            ...
            if($this->form_validation->run() == FALSE) {
                ...
                $this->load->view('marketing/_layout/header', $data);
                $this->load->view('marketing/_layout/sidebar');
                $this->load->view('marketing/pages/D_reportquotation', $data);
                $this->load->view('marketing/_layout/footer');
            } else {
                $from = $_GET['from'];
                $to = $_GET['to'];
    ...
    public function add_stps($id)
    {
        ...
        $this->load->view('marketing/_layout/header', $data);
        $this->load->view('marketing/_layout/sidebar');
        $this->load->view('marketing/pages/D_addstps', $data);
        $this->load->view('marketing/_layout/footer');
    }
    }
    ...
    public function add_stps_action()
    {
        ...
        if($this->form_validation->run() == FALSE) {
            ...
            redirect('D_marketing/add_stps/' . $id);
        }
    }
    ...
    public function delete_stps($id, $id_sk)
	{
		...
		redirect('D_marketing/add_stps/' . $id_sk);
        }
	}
    ...
    public function print_stps($id) {
        ...
        $this->load->view('marketing/pages/D_printstps', $data);
    }
    }
    ...
    public function data_stps()
    {
        ...
        $this->load->view('marketing/_layout/header', $data);
        $this->load->view('marketing/_layout/sidebar');
        $this->load->view('marketing/pages/D_liststps', $data);
        $this->load->view('marketing/_layout/footer');
    }
    }
    ...
    public function add_sampler_stps($id)
    {
        ...
        $this->load->view('marketing/_layout/header', $data);
        $this->load->view('marketing/_layout/sidebar');
        $this->load->view('marketing/pages/D_addsamplerstps', $data);
        $this->load->view('marketing/_layout/footer');
    }
    }
    ...
    public function add_sampler_stps_action()
    {
        ...
        if($this->form_validation->run() == FALSE) {
            ...
            redirect('D_marketing/add_sampler_stps/' . $id);
        }
    }
    ...
    public function delete_sampler_stps($id, $id_sk)
	{
		...
		redirect('D_marketing/add_sampler_stps/' . $id_sk);
        }
	}
    ...
    public function add_stp($id)
    {
        ...
        $this->load->view('marketing/_layout/header', $data);
        $this->load->view('marketing/_layout/sidebar');
        $this->load->view('marketing/pages/D_addstp', $data);
        $this->load->view('marketing/_layout/footer');
    }
    }
    ...
    public function update_stp_action()
    {
        ...
        redirect('D_marketing/add_stp/' . $id_sk);
    }
    ...
    public function print_stp($id) {
        ...
        $this->load->view('marketing/pages/D_printstp', $data);
    }
    }
    ...
    public function data_stp()
    {
        ...
        $this->load->view('marketing/_layout/header', $data);
        $this->load->view('marketing/_layout/sidebar');
        $this->load->view('marketing/pages/D_liststp', $data);
        $this->load->view('marketing/_layout/footer');
    }
    }
    ...
    public function add_sampler_stp($id)
    {
        ...
        $this->load->view('marketing/_layout/header', $data);
        $this->load->view('marketing/_layout/sidebar');
        $this->load->view('marketing/pages/D_addsamplerstp', $data);
        $this->load->view('marketing/_layout/footer');
    }
    }
    ...
    public function add_sampler_stp_action()
    {
        ...
        if($this->form_validation->run() == FALSE) {
            ...
            $this->web->insert_data($data, 'assign_sampler');
            $this->session->set_flashdata('msg', 'Assignment sampler success.');
            redirect('D_marketing/add_sampler_stp/' . $id);
        }
    }
    ...
    public function delete_sampler_stp($id, $id_sk)
	{
		...
		$this->web->delete_data($where, 'assign_sampler');
        $this->session->set_flashdata('msg', 'Sampler success deleted.');
		redirect('D_marketing/add_sampler_stp/' . $id_sk);
        }
	}
    ...
    public function data_analysis_coa($id)
    {
        ...
        $this->load->view('marketing/_layout/header', $data);
        $this->load->view('marketing/_layout/sidebar');
        $this->load->view('marketing/pages/D_analysiscoa', $data);
        $this->load->view('marketing/_layout/footer');
    }
    }
    ...
    public function input_result($id, $id_sk)
    {
        ...
        $this->load->view('marketing/_layout/header', $data);
        $this->load->view('marketing/_layout/sidebar');
        $this->load->view('marketing/pages/D_inputresult', $data);
        $this->load->view('marketing/_layout/footer');
    }
    }
    ...
    public function save_result() {
        ...
        redirect('D_marketing/input_result/' . $this->input->post('id_analysis') . '/' . $id_sk);
        }
    }
    ...
    public function draft_coa($id_sk) {
        ...
        $paper_size = 'A4';
        $orientation = 'potrait';
        $html = $this->load->view('marketing/pages/D_draftcoa', $data, TRUE);;
    ...
    public function pdf_coa($id_sk) {
        ...
        $paper_size = 'A4';
        $orientation = 'potrait';
        $html = $this->load->view('marketing/pages/D_pdfcoa', $data, TRUE);;
        $this->dompdf->set_paper($paper_size, $orientation);
    ...
    public function list_users()
    {
        ...
        $this->load->view('marketing/_layout/header', $data);
        $this->load->view('marketing/_layout/sidebar');
        $this->load->view('marketing/pages/D_listusers', $data);
        $this->load->view('marketing/_layout/footer');
    }
    }
    ...
    public function add_user() {
        ...
        $this->load->view('marketing/_layout/header', $data);
        $this->load->view('marketing/_layout/sidebar');
        $this->load->view('marketing/pages/D_adduser');
        $this->load->view('marketing/_layout/footer');
    }
    }
    ...
    public function add_user_action() {
        ...
        if($this->form_validation->run() == false) {
            ...
            redirect('D_marketing/list_users/');
        }
    }
    }
    ...
    public function update_company_profile() {
        ...
        $this->load->view('marketing/_layout/header', $data);
        $this->load->view('marketing/_layout/sidebar');
        $this->load->view('marketing/pages/D_settingscompany');
        $this->load->view('marketing/_layout/footer');
    }
    }
    ...
    public function update_company_profile_action() {
        ...
        if($this->form_validation->run() == false) {
            ...
            redirect('D_marketing/update_company_profile/');
        }
    }
    }
