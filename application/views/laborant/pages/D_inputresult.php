                ...
                <div class="row">
                    ...
                    <hr>
                      <?php if($coa == NULL) { ?>
                        ...
                        <?php } else { ?>
                          <form action="<?= base_url('D_laborant/save_result') ?>" method="post">
                            ...
                            <a href="<?= base_url('D_laborant/data_analysis_coa/') . $row->id_sk ?>" class="btn btn-danger float-left mr-2"><i class="fas fa-arrow-left"></i> Back to List Analysis</a>
                          </form>
                        <?php } ?>
                    </div>
                </div>
