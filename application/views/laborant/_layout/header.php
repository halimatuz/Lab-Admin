...
<head>
  ...
  if ($this->uri->segment(2) == "" || $this->uri->segment(2) == "index") {
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/jquery-selectric/selectric.css">
    <?php
  } elseif ($this->uri->segment(1) == "D_laborant" && $this->uri->segment(2) == "") {
    ?>
    <?php
...
if ($this->uri->segment(2) == "layout_transparent") {
  $this->load->view('laborant/_layout/layout-2');
  $this->load->view('laborant/_layout/sidebar-2');
} elseif ($this->uri->segment(2) == "layout_top_navigation") {
  $this->load->view('laborant/_layout/layout-3');
  $this->load->view('laborant/_layout/navbar');
  ...
  $this->load->view('laborant/_layout/layout');
