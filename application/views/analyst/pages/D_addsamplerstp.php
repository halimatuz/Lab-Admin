            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($special_assign as $sa) : ?>
                        <form action="<?= base_url('D_superadmin/update_sampler_stp_action') ?>" method="POST">
                            ...
                            <a href="<?php echo base_url('D_superadmin/add_sampler_stp/') . $sk_number->id_sk ?>" class="btn btn-danger">Cancel</a>
                        </form>
                    <?php endforeach; } else {?>
                        <form action="<?= base_url('D_superadmin/add_sampler_stp_action') ?>" method="POST">
                            <div class="form-group">
                                <label>Sampler</label>
                            ...
                            <tbody>
                                ...
                                foreach ($assign_sampler as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('D_superadmin/update_sampler_stp/') . $row->id_assign . '/' . $row->id_sk ?>"class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <a href="<?= base_url('D_superadmin/delete_sampler_stp/') . $row->id_assign . '/' . $row->id_sk ?>"class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
