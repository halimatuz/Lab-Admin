            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($specialmethod as $ss) : ?>
                        <form action="<?= base_url('D_superadmin/update_method_action') ?>" method="POST">
                    ...
                    <?php endforeach; } else {?>
                        <form action="<?= base_url('D_superadmin/add_method') ?>" method="POST">
                            <div class="form-group">
                                <label>Name method</label>
                            ...
                            <tbody>
                                ...
                                foreach ($method as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('D_superadmin/update_method/') . $row->id_method ?>"class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <a href="<?php echo base_url('D_superadmin/delete_method/') . $row->id_method ?>"class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
