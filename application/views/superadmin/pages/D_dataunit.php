            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($specialunit as $ss) : ?>
                        <form action="<?= base_url('D_superadmin/update_unit_action') ?>" method="POST">
                            ...
                            <a href="<?php echo base_url('D_superadmin/data_unit') ?>" class="btn btn-danger">Cancel</a>
                        </form>
                    <?php endforeach; } else {?>
                        <form action="<?= base_url('D_superadmin/add_unit') ?>" method="POST">
                            <div class="form-group">
                                <label>Name unit</label>
                            ...
                            <tbody>
                                ...
                                foreach ($unit as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('D_superadmin/update_unit/') . $row->id_unit ?>"class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <a href="<?php echo base_url('D_superadmin/delete_unit/') . $row->id_unit ?>"class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
