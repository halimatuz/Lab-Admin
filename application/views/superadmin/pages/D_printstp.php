    ...
    <div class="container mt-5">
      <div class="row">
        ...
        <div class="col-md-3 text-center">
          <p>Bekasi, <?= date('dS F, Y', strtotime($smpl_det->date_analysis)); ?><br><?= $cmp->name ?></p>
          <img src="<?= base_url('assets/img/company_profile/tp_signature/') . $cmp->tp_signature ?>" alt="" class="ml-3" width="200px">
          <p><u class="font-weight-bold">Fadhelun</u><br>PJ Teknis</p>
        </div>
      </div>
    </div>
