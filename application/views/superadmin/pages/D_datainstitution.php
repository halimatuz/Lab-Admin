            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($specialInt as $si) : ?>
                        <form action="<?= base_url('D_superadmin/update_int_action') ?>" method="POST">
                            ...
                            <a href="<?php echo base_url('D_superadmin/data_int') ?>" class="btn btn-danger">Cancel</a>
                        </form>
                    <?php endforeach; } else {?>
                        <form action="<?= base_url('D_superadmin/add_int') ?>" method="POST">
                            <div class="form-group">
                                <label>Name Institution</label>
                            ...
                            <tbody>
                                ...
                                foreach ($institution as $int) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('D_superadmin/update_int/') . $int->id_int ?>"class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <a href="<?php echo base_url('D_superadmin/delete_int/') . $int->id_int ?>"class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
