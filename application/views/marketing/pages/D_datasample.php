            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($specialSample as $ss) : ?>
                        <form action="<?= base_url('D_marketing/update_sample_action') ?>" method="POST">
                            ...
                            <a href="<?php echo base_url('D_marketing/data_sample') ?>" class="btn btn-danger">Cancel</a>
                        </form>
                    <?php endforeach; } else {?>
                        <form action="<?= base_url('D_marketing/add_sample') ?>" method="POST">
                            <div class="form-group">
                                <label>Name Sample</label>
                            ...
                            <tbody>
                                ...
                                foreach ($sample as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('D_marketing/update_sample/') . $row->id_sample ?>"class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <a href="<?php echo base_url('D_marketing/delete_sample/') . $row->id_sample ?>"class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
