                            ...
                            <tbody>
                                ...
                                foreach ($quotation as $qtn) : ?>
                                    <tr>
                                        ...
                                        <td>
                                          <?php if($this->uri->segment(2) == 'list_quotation') { ?>
                                              <a href="<?= base_url('D_marketing/add_quotation/') . $qtn->id_sk ?>" class="btn btn-primary"><i class="fas fa-edit"></i> Edit Quotation</a>
                                              <?php if ($qtn->status_po == 0) { ?>
                                                <a href="<?= base_url('D_marketing/verifikasi/cek/') . $qtn->id_sk ?>" class="btn btn-success btn-xs" title="PO"><i class="fas fa-check"></i></a>
                                              <?php } else { ?>
                                                <a href="<?= base_url('D_marketing/verifikasi/cek/') . $qtn->id_sk ?>" class="btn btn-danger btn-xs" title="Cancel PO"><i class="fas fa-times"></i></a>
                                              <?php } ?>
                                          <?php } elseif($this->uri->segment(2) == 'data_stps_index') { ?>
                                            <?php if($qtn->sk_sample == 0) { ?>
                                              <a href="<?php echo base_url('D_marketing/add_stps/') . $qtn->id_sk ?>"class="btn btn-success"><i class="fas fa-plus"></i> Add STPS</a>
                                            <?php } else { ?>
                                              <a href="<?php echo base_url('D_marketing/add_stps/') . $qtn->id_sk ?>"class="btn btn-primary"><i class="fas fa-edit"></i> Edit STPS</a>
                                            <?php } ?>
                                          <?php } elseif($this->uri->segment(2) == 'data_stp_index') { ?>
                                            <?php if($qtn->sk_analysis == 0) { ?>
                                              <a href="<?php echo base_url('D_marketing/add_stp/') . $qtn->id_sk ?>"class="btn btn-success"><i class="fas fa-plus"></i> Add STP</a>
                                            <?php } else { ?>
                                              <a href="<?php echo base_url('D_marketing/add_stp/') . $qtn->id_sk ?>"class="btn btn-primary"><i class="fas fa-edit"></i> Edit STP</a>
                                            <?php } ?>
