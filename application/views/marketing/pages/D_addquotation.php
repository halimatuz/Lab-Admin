            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($specialQuotation as $qtn) : ?>
                        <form action="<?= base_url('D_marketing/update_quotation_action') ?>" method="POST">
                            ...
                            <a href="<?php echo base_url('D_marketing/add_quotation/') . $sk->id_sk ?>" class="btn btn-danger">Cancel</a>
                        </form>
                    <?php endforeach; } else {?>
                        <form action="<?= base_url('D_marketing/add_quotation_action') ?>" method="POST">
                            <div class="form-group">
                                <label>Analysis</label>
                                <input type="hidden" name="id_int" value="<?= $sk->id_int ?>">
                    ...
                    <div class="col-md-8">
                        <a href="<?= base_url('D_marketing/print_quotation/') . $sk->id_sk ?>" class="btn btn-primary">Print</a>
                        <hr>
                            ...
                            <tbody>
                                ...
                                @$jumlah += $amount; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('D_marketing/update_quotation/') . $row->id_sk . '/'  . $row->id_quotation ?>"class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <a href="<?= base_url('D_marketing/delete_quotation/') . $row->id_quotation . '/' . $row->id_int . '/'  . $row->id_analysis . '/' . $row->id_sk?>"class="btn btn-danger tombol-hapus" type="submit"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
