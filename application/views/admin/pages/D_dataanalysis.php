            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($specialAnalysis as $sa) : ?>
                        <form action="<?= base_url('D_admin/update_analysis_action') ?>" method="POST">
                            ...
                            <a href="<?php echo base_url('D_admin/data_analysis') ?>" class="btn btn-danger">Cancel</a>
                        </form>
                    <?php endforeach; } else {?>
                        <form action="<?= base_url('D_admin/add_analysis') ?>" method="POST">
                            <div class="form-group">
                                <label>Name Analysis</label>
                            ...
                            <tbody>
                                ...
                                foreach ($analysis as $anl) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('D_admin/update_analysis/') . $anl->id_analysis ?>"class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <a href="<?php echo base_url('D_admin/delete_analysis/') . $anl->id_analysis ?>"class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
