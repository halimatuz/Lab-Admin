            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($specialcoa as $ss) : ?>
                        <form action="<?= base_url('D_admin/update_coa_action') ?>" method="POST">
                        <?php foreach($specialcoa as $sc) : ?>
                            ...
                            <a href="<?php echo base_url('D_admin/add_coa/' . $analysis->id_analysis) ?>" class="btn btn-danger">Cancel</a>
                        </form>
                    <?php endforeach; } else {?>
                        <form action="<?= base_url('D_admin/add_coa_action') ?>" method="POST">
                            <?php if($analysis->name_analysis != 'Vibration' && $analysis->name_analysis != 'Noise' && $analysis->name_analysis != 'Heat Stress' && $analysis->name_analysis != 'Illumination' && $analysis->name_analysis != 'Non-Stationary Source Emission' && $analysis->name_analysis != '24 HOURS NOISE') { ?>
                            <div class="form-group">
                                <label>Parameters</label>
                            ...
                            <tbody>
                                ...
                                foreach ($coa as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('D_admin/update_coa/') . $row->id_coa  . '/' . $row->id_analysis?>"class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <a href="<?php echo base_url('D_admin/delete_coa/') . $row->id_coa . '/' . $row->id_analysis?>"class="btn btn-danger tombol-hapus" type="submit"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
