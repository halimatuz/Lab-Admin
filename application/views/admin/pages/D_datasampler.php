            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($specialSampler as $ss) : ?>
                        <form action="<?= base_url('D_admin/update_sampler_action') ?>" method="POST">
                            ...
                            <a href="<?php echo base_url('D_admin/data_sampler') ?>" class="btn btn-danger">Cancel</a>
                        </form>
                    <?php endforeach; } else {?>
                        <form action="<?= base_url('D_admin/add_sampler') ?>" method="POST">
                            <div class="form-group">
                                <label>Name Sampler</label>
                            ...
                            <tbody>
                                ...
                                foreach ($sampler as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('D_admin/update_sampler/') . $row->id_sampler ?>"class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <a href="<?php echo base_url('D_admin/delete_sampler/') . $row->id_sampler ?>"class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
