                ...
                <div class="row">
                    ...
                    foreach ($specialQuotation as $qtn) : ?>
                        <form action="<?= base_url('D_admin/update_quotation_action') ?>" method="POST">
                            ...
                            <a href="<?php echo base_url('D_admin/add_quotation/') . $institution->id_int . '/' . $sk->id_sk ?>" class="btn btn-danger">Cancel</a>
                        </form>
                    <?php endforeach; } else {?>
                            ...
                            <tbody>
                                ...
                                @$jumlah += $amount; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('D_admin/update_quotation/') . $row->id_int . '/'. $row->id_sk . '/'  . $row->id_quotation ?>"class="btn btn-primary"><i class="fas fa-edit"></i></a>
