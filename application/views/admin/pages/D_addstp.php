          ...
          <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                          <a href="<?= base_url('D_admin/print_stp/') . $sk_number->id_sk ?>" class="btn btn-primary float-right" target="_blank">Print</a>
                        ...
                        <?php } else { ?>
                        <form action="<?= base_url('D_admin/update_stp_action') ?>" method="POST">
                          ...
                          <a href="<?= base_url('D_admin/data_stp_index') ?>" class="btn btn-danger float-left"><i class="fas fa-arrow-left"></i> Back to List Quotation</a>
                        </form>
                        <?php } ?>
                    </div>
                </div>
