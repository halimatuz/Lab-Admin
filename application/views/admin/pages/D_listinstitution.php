                            ...
                            <tbody>
                                ...
                                foreach ($institution as $int) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('D_admin/generate_sk/') . $int->id_int ?>" class="btn btn-success tombol-generate"><i class="fas fa-plus"></i> Generate SK</a>
                                            <a href="<?= base_url('D_admin/list_quotation/') . $int->id_int ?>"class="btn btn-primary"><i class="fas fa-file"></i> List Quotation</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
