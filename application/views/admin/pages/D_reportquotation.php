          ...
          <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <hr>
                    <form action="<?= base_url('D_admin/report_quotation') ?>" method="GET">
                            ...
                            <tbody>
                                ...
                                foreach ($quotation as $qtn) : ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url('D_admin/print_quotation/') . $qtn->id_sk ?>" class="btn btn-primary"><i class="fas fa-print"></i> Print</a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                            </table>
