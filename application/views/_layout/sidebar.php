...
<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <li class="menu-header">Main Feature</li>
      ...
      <li class="dropdown <?php echo $this->uri->segment(1) == 'D_institution' || $this->uri->segment(1) == 'D_analysis' || $this->uri->segment(1) == 'D_sampler' || $this->uri->segment(1) == 'D_sample' ? 'active' : ''; ?>">
