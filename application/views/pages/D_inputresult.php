                ...
                <div class="row">
                    ...
                    <hr>
                      <?php if($coa == NULL) { ?>
                        ...
                        <?php } else { ?>
                          <form action="<?= base_url('d_gencoa/save_result') ?>" method="post">
                            ...
                            <a href="<?= base_url('D_gencoa/data_analysis/') . $row->id_sk ?>" class="btn btn-danger float-left mr-2"><i class="fas fa-arrow-left"></i> Back to List Analysis</a>
                          </form>
                        <?php } ?>
                    </div>
                </div>
