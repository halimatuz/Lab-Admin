            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($specialmethod as $ss) : ?>
                        <form action="<?= base_url('D_method/update_method_action') ?>" method="POST">
                            ...
                            <a href="<?php echo base_url('D_method') ?>" class="btn btn-danger">Cancel</a>
                        </form>
                    <?php endforeach; } else {?>
                        <form action="<?= base_url('D_method/add_method') ?>" method="POST">
                            <div class="form-group">
                                <label>Name method</label>
