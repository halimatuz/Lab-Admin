            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($special_assign as $sa) : ?>
                        <form action="<?= base_url('D_stps/update_sampler_stps_action') ?>" method="POST">
                            ...
                            <a href="<?php echo base_url('D_stps/add_sampler_stps/') . $sk_number->id_sk ?>" class="btn btn-danger">Cancel</a>
                        </form>
                    <?php endforeach; } else {?>
                        <form action="<?= base_url('D_stps/add_sampler_stps_action') ?>" method="POST">
                            <div class="form-group">
                                <label>Sampler</label>
                            ...
                            <tbody>
                                ...
                                foreach ($assign_sampler as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('D_stps/update_sampler_stps/') . $row->id_assign . '/' . $row->id_sk ?>"class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <a href="<?= base_url('D_stps/delete_sampler_stps/') . $row->id_assign . '/' . $row->id_sk ?>"class="btn btn-danger tombol-hapus"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
